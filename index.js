...
const salvarAtividade = (event) => {
  ...
  const atividadeExiste = atividades.some(atividade => atividade.data.getTime() === novaAtividade.data.getTime());
...
const concluirAtividade = (event) => {
  ...
  const atividade = atividades.find(atividade => atividade.data.getTime() === dataDesteInput.getTime());
